...
//package view.scenes
//
//import model.{Board, Card, Task, Column}
...
//  TextInputDialog
//}
//import scalafx.scene.input.{ClipboardContent, KeyCode, KeyCodeCombination, KeyCombination, TransferMode}
...
//          for card <- guiColumn.getColumn.cards do guiColumn.children += createGuiCard(card)
//
...
//        board.removeCardFilter()
//        updateBoard()
//
//      def sortByDeadline(): Unit =
//        board.sortCardsByEndDate()
//        updateBoard()
//
//      this.items ++= Seq(
...
//          alert.contentText = "Move or delete all the cards in the column if you want to delete the column"
//          alert.showAndWait()
//      else
//        val alert = new Alert(AlertType.Warning)
//        alert.initOwner(mainStage)
...
//    val deadline = new GuiCardDeadline(card.endDate)
...
//        progress = card.calculateChecklistProgress()
...
//      val checklistItem = card.addChecklistTask()
...
//  end createGuiCard
//
//  def createGuiChecklistItem(checklistItem: Task): BorderPane =
...
//      guiCard.getCard.removeChecklistTask(checklistItem)
